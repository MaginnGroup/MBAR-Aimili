...
include_unsampled = 'yes' # if 'yes', specify T (K) and P (MPa - only NPT ensemble) for new states
unsampled_T = [465.15,470.15,480.15,490.15,500.15,510.15,520.15,530.15,540.15,550.15,560.15,570.15,580.15,590.15,600.15]
unsampled_P = [95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0,95.0]
